...
CREATE TABLE `a_p_i3_comments` (
  `id` int UNSIGNED NOT NULL,
  `postid` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `deviceid` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `latitude` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `longitude` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `commenttext` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `username` varchar(255) CHARACTER SET utf8mb4 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `a_p_i4_users` (
  `id` int UNSIGNED NOT NULL,
  `apikey` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `a_p_i6_users` (
  ...
  `username` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `password` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `credit` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `a_p_i7_users` (
  ...
  `username` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `password` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `authkey` varchar(255) CHARACTER SET utf8mb4 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `a_p_i8_users` (
  ...
  `password` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `authkey` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `secret` varchar(255) CHARACTER SET utf8mb4 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `a_p_i9_users` (
  `id` int UNSIGNED NOT NULL,
  `username` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `pin` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `accbalance` varchar(255) CHARACTER SET utf8mb4 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
